                ...
                >
                  {item.dropdown.map((subItem, subIndex) => (
                    <a
                      key={subIndex}
                      href={subItem.link}
                      className="py-2 text-white hover:text-[#fb1359] flex items-center justify-between px-8 group-hover:px-2 rounded-md transition-all duration-500 ease-in-out"
                    >
                      {subItem.name}
